...
const SnsMyProfileHeader = (props) => {
    return (
        ...
        <img
            ...
            // src={this.state.avatar ? this.state.avatar : require('../../../public/noimagetop.png')}
            src={props.imgrul2}
            alt='dd'/>
...
class test extends Component {
    ...
    constructor(props) {
        super(props);
        let links = ["https://graph.facebook.com/386251168518864/picture?type=large", "https://graph.facebook.com/386251168518864/picture?type=large", "https://graph.facebook.com/386251168518864/picture?type=large", "https://graph.facebook.com/386251168518864/picture?type=large"]
        this.state = {
    ...
    render() {
        ...
        const SnsAnswerPageQuestionPicView = props => {
            ...
            return (
                props.imageUrl && <div className="snsAnswerPage-content-questionImage-div"
                style={{
        ...
        const SnsAnswerPageChoosePicCell = (props) => (
            ...
            <div className="snsAnswerPage-cell-pic-content-div" onClick={this.handleClick(props.index)}>
                <div
                    ...
                    // style={{
                    //     // backgroundImage: `url(${this.state.images.url})`
                    //     backgroundImage: `url(https://graph.facebook.com/386251168518864/picture?type=large)`
                    // }}>
                    >
                    <img className = "imagecell"  
        ...
        return (
            <div className="snsAnswerPage-content-backgroundColor">
                ...
                <img className = "imagecell"  
                            ...
                            alt="text"
                        />
                    <SnsMyProfileHeader imgurl='https://graph.facebook.com/386251168518864/picture?type=large' imgrul2='http://image.deja.fashion/product/upload/b5/9b/b59ba61e531928d7c7012c74ab2fc9b5'/>
                    <SnsAnswerPageHeader topic_name={this.state.topic_name}/>
                    <SnsAnswerPageQuestionPicView imageUrl={this.state.questionImageUrl}/>
                    <SnsAnswerPageChoosePicContentView data={this.state.options}/>
...
// class SnsMyProfileHeader extends React.Component {
//     render() {
//         return (
//                 <div>
//                 <img
//                     className="snsAnswerPage-SnsMyProfileHeader-avatar"
//                     // src={this.state.avatar ? this.state.avatar : require('../../../public/noimagetop.png')}
//                     src='http://image.deja.fashion/product/upload/b5/9b/b59ba61e531928d7c7012c74ab2fc9b5'
//                     alt='dd'/>
//                     <img className = "imagecell"  
//                             src='https://graph.facebook.com/386251168518864/picture?type=large' 
//                         alt="text"
